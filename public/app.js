  ...
  return `
    <div class="ruleboxes">
      ...
      ${box("\u{1F3CE}\uFE0F The Grand Prix Arsenal", [
        ...
        "The number beside the price is how many you may arm for one race. Where a token stacks, each one armed does it again; where it cannot, one is the whole of it. <b>Nothing that fails to take hold at the lights is spent</b> \u2014 a canister with no hand to sit in stays in your bag.",
        "<b>Start Boost</b> ($600, 3): 200 metres off the line, each. <b>Tow Rope</b> ($900, 3): five answers each pay 20 metres more, five more per rope. <b>Warm-Up Lap</b> ($700, 3): three answers pay full whatever the clock said, three more each.",
        "<b>Slipstream Canister</b> ($1,200, 2) and <b>Nitro Canister</b> ($1,500, 2): start the race already holding one. You have one hand, so a second canister of any kind needs a <b>Twin Box</b> to sit in.",
