...
export const ARSENALS = {
  ...
  prix: {
    ...
    gp_fuel:    { name: "Long Fuel",          price: 1_800, max: 1, icon: "\u26FD" },
    gp_warmup:  { name: "Warm-Up Lap",        price: 700,   max: 3, icon: "\u{1F321}\uFE0F" },
    gp_tyres:   { name: "Slick Tyres",        price: 700,   max: 1, icon: "\u{1F6DE}" },
    gp_seal:    { name: "Scrutineer's Seal",  price: 1_100, max: 3, icon: "\u{1F6E1}\uFE0F" },
    gp_guards:  { name: "Mudguards",          price: 800,   max: 1, icon: "\u{1F6E2}\uFE0F" },
    gp_visor:   { name: "Sun Visor",          price: 1_000, max: 1, icon: "\u{1F576}\uFE0F" },
    gp_radio:   { name: "Pit Radio",          price: 600,   max: 1, icon: "\u{1F4FB}" },
    gp_spotter: { name: "Spotter",            price: 900,   max: 3, icon: "\u{1F52D}" },
    gp_spare:   { name: "Spare Word",         price: 500,   max: 5, icon: "\u{1F9F0}" },
    gp_tele:    { name: "Telemetry",          price: 1_300, max: 1, icon: "\u{1F4E1}" },
    gp_twin:    { name: "Twin Box",           price: 2_000, max: 1, icon: "\u{1F381}" },
